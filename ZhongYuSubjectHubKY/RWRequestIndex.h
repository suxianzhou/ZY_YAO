...
#define UMengCommunityAppkey @"5762610b67e58eea66001c6b"
#define UMengCommunityAppSecret @"9cedab0b0cc8097773fe3039ec8426ca"

#define MOB_CLICK @"57316e8167e58e28c4000286"
...
//>> 题库目录
#define YY_INDEX @"http://www.zhongyuedu.com/api/yy_yao_list.php"
//>> 预约列表
...
//>> 上传
#define EXPERIENCE_TIMES_URL @"http://www.zhongyuedu.com/api/yao_limit.php"
//>> 天王盖地虎
#define RECEIVE_PUSH @"http://www.zhongyuedu.com/api/yao_url.php"
//>> push
#define LOGIN_URL @"http://www.zhongyuedu.com/api/tk_yao_new_login.php"
//>> 登录
#define REGISTER_URL @"http://www.zhongyuedu.com/api/tk_yao_register.php"
//>> 注册
#define REPLACE_PASSWORD_URL @"http://www.zhongyuedu.com/api/yao_change_pwd.php"
//>> 重置密码
#define ABOUT_US @"http://www.zhongyuedu.com/api/tk_aboutUs.htm"
//>> 关于我们
#define README @"http://www.zhongyuedu.com/app/tk_yao/tk_ios_usage.htm"
//>> 使用说明
